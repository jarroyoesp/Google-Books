...
import es.jarroyo.books.domain.usecase.location.deleteWeatherLocation.DeleteWeatherLocationUseCase
import es.jarroyo.books.domain.usecase.location.getAllWeatherLocationList.GetAllWeatherLocationListUseCase
import es.jarroyo.books.domain.usecase.location.saveWeatherLocation.SaveWeatherLocationUseCase
import es.jarroyo.books.ui.viewmodel.model.location.*
